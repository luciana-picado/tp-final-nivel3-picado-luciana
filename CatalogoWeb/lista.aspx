...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <%} %>
            <asp:GridView ID="dgvArticulos" OnSelectedIndexChanged="dgvArticulos_SelectedIndexChanged1" DataKeyNames="Id" AutoGenerateColumns="false" CssClass="table" runat="server">
                <Columns>
    ...
    <div>
        ...
        <asp:Button ID="btnRefrescar" OnClick="btnRefrescar_Click" CssClass=" btn btn-primary" runat="server" Text="Refrescar" />
    </div>
</asp:Content>
